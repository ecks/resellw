...
extern struct prices * get_range_sell_price_listings_buy_now(char * low_price, char * high_price);
extern struct prices * get_range_sell_price_listings(char * low_price, char * high_price);
